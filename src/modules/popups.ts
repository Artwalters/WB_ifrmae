    ...
    html: `
        <div class="popup-wrapper">
          ...
          <div class="popup-side popup-front">
            <div class="content-wrapper">
              ${properties.image ? `<div class="popup-image-wrapper"><img class="popup-image" src="${properties.image}" alt="" /><div class="popup-image-fade" style="background: linear-gradient(to top, ${properties.color || '#6B46C1'} 0%, transparent 100%);"></div></div>` : ''}
